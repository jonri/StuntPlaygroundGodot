...
export var steering_max_angle = 0.45
export var steering_speed = 3.4
export var steering_percent_drop = 0.80
export var steering_from_speed = 10
export var steering_to_speed = 50
...
var torque_curve_rpms = [500, 5000, 5500, 6500, 7500, 10000]
var torque_curve_torques = [500, 800, 900, 1200, 1500, 0]
var gear_ratios = [-5.0, 4, 3.2, 2.8, 2.2, 2.0]
var differential_ratio = 2.1
var transmission_efficiency = 0.75
var drag_coefficient = 0.75
var brake_strength = 60
...
func _physics_process(delta):
	...
	if Input.is_action_just_pressed("reset"):
		apply_impulse(Vector3(1, 0, 0), Vector3(0, 4000, 0))
	...
	var omega = linear_velocity.length() / 0.7 * 6.28;
	...
	engine_force = wheel_torque * 0.7 * 2
